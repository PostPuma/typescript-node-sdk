...
export class AccountsApi {
     ...
     */
    public async getAccount (accountUuid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Account;  }> {
        const localVarPath = this.basePath + '/accounts/{accountUuid}'
     ...
     */
    public async listAccounts (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAccounts200Response;  }> {
